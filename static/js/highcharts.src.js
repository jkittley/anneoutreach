...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/4.1.1-modified/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com/4.1.1-modified/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
